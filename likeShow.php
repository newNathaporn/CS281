							...
							<p align="center"> <a class='btn btn-primary' href="
								...
								<form id="frmcart" name="frmcart" method="post" action="?act=update">
									<table width="100%" border="0" align="center" class="table table-hover">
										...
										<?php
									if (!($member == null)) {
										$arrcart = Addtable::insertAlllike($member->getidUser());
										$sum = 0;
										foreach ($arrcart as $data) { ?>
											<tr>
												<td align="center">
													<?php echo $member->getfirstname(); ?> </td>
												<td align="center">
													<?php echo $data->getname(); ?>
												</td>
												<td align="center">
													<?php echo $data->getprice() - $data->getsale(); ?>
												</td>
												<td align="center">
													<?php 
												// $username = $data['name_user'];
												echo "<a href='Control/Add.php?id=unlike&id_product=" . $data->getid_product() . "&username=" . $member->getidUser() . "' class='btn btn-danger btn-xs'>UNLIKE</a>"; ?>
												</td>
											</tr>
										 <?php 
									} ?>
					...
					<div class="sign-grds">
						<div class="col-md-4 sign-gd">
							...
							<ul>
								...
								<li>
									<a href="mens.html">Men's Perfumes</a>
								</li>
								<li>
									<a href="womens.html">Women's Perfumes</a>
								</li>
								<li>
