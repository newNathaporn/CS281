...
$pro_id = $_GET['brand'];
$Cartproduct = Product::insertNameBrand($conn, $_GET['brand']);
if ($Cartproduct == null) {
	header('location:index.php');
	exit;
}
...
<body>
				...
				<div class="agile_inner_breadcrumb">
					...
					<ul class="w3_short">
						<li>
							...
							<a>|<?php echo "  " . $Cartproduct[0]->getname_brand() ?> </a>
						</li>
						<!-- <li>
	...
	<div class="banner-bootom-w3-agileits">
		...
		<div class="single-pro">
			<?php foreach ($Cartproduct as $s => $value) { ?>
					...
					<div class="item-info-product ">
						...
						<div class="info-product-price">
							<span class="item_price">฿
								<?php echo $value->getprice() - $value->getsale(); ?>.00</span>
							<del>฿
								<?php echo $value->getprice(); ?>.00</del>
						</div> Amount
						<?php echo $value->getqty(); ?> items
