				...
				<div class="container">
					<div class="agile_ab_w3ls_info">
							<div class="col-md-12 ab_pic_w3ls_text_info">
								<p align="center"> <a href=CartShow.php class="btn btn-primary">กลับไปตะกร้าสินค้า</a> </p>
									<table width="100%" border="0" align="center" class="table table-hover">
										<tr>
											<td height="40" colspan="5" align="center" bgcolor="#CCCCCC"><strong><b>รายการจัดซื้อสินค้า</span></strong></td>
										</tr>
										<td align="center" bgcolor="#EAEAEA"><strong>Order</strong></td>
										<td align="center" bgcolor="#EAEAEA"><strong>Customer</strong></td>
										<td align="center" bgcolor="#EAEAEA"><strong>จำนวนสินค้า</strong></td>
										<td align="center" bgcolor="#EAEAEA"><strong>ยอดรวม</strong></td>
										</tr>
										 ...
										 <?php
										if (!($member == null)) {
											$arrcart = Addtable::searchhistory($conn, $member->getidUser());
											for ($i = 0; $i < count($arrcart) / 4; $i++) {
												echo "<tr>\n";
												echo "<td align=\"center\">" . $arrcart[$i * 4] . " </td>\n";
												echo "<td align=\"center\">" . $member->getfirstname() . " " . $member->getlastname() . "</td>\n";
												echo "<td align=\"center\">" . $arrcart[$i * 4 + 2] . "</td>\n";
												echo "<td align=\"center\">" . $arrcart[$i * 4 + 3] . "</td>\n";
												echo "</tr>\n";
												?>
										 <?php
									...
									<form method="post" action="https://www.thaiepay.com/epaylink/payment.aspx" align="center">
										...
										<input type="hidden" name="customeremail" value="newlittlegirllovely@gmail.com">
										<input type="hidden" name="productdetail" value="Testing Product">
										<input type="hidden" name="returnurl" value="http://localhost/web/web/index.php">
