							...
							<div class="col-md-12 ab_pic_w3ls_text_info">
								<p align="center"> <a href=CartShow.php class="btn btn-primary">กลับไปตะกร้าสินค้า</a> </p>
									<table width="100%" border="0" align="center" class="table table-hover">
										<tr>
											<td height="40" colspan="5" align="center" bgcolor="#CCCCCC"><strong><b>ประวัติการจัดซื้อสินค้า</span></strong></td>
										</tr>
										<td align="center" bgcolor="#EAEAEA"><strong>Order</strong></td>
										<td align="center" bgcolor="#EAEAEA"><strong>Customer</strong></td>
										<td align="center" bgcolor="#EAEAEA"><strong>วันที่สั่งซื้อ:</strong></td>
										...
										if (!($member == null)) {
											...
											for ($i = 0; $i < count($arrcart) / 4; $i++) {
												...
												echo "<td align=\"center\">" . $arrcart[$i * 4 + 1] . " </td>\n";
