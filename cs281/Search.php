...
if ($_SESSION["arraysearch"] == null) {
	echo "<script>alert('ไม่พบสินค้าครับ/ค่ะ'); window.location='../web/index.php'</script>";
	exit();
} else {
	$arraysearch = Product::addsearchProduct($_SESSION["arraysearch"]);
}
